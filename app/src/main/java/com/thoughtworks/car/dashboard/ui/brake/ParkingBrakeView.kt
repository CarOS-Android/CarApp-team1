...
fun ParkingBrakeView(
    ...
    Box(
        modifier = Modifier.clickable { toggleParkingBrake() },
        contentAlignment = Alignment.Center,
    ) {
        Image(
            painter = painterResource(id = R.drawable.parking_barke_background),
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Image(
                painter = painterResource(
                    id = if {
                        (uiState.parkingBrakeUiState) R.drawable.auto_hold_on
                    } else {
